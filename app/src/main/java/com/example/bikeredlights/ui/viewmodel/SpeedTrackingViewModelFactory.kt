 ...
 * Hilt is re-enabled in v0.1.0). It provides the LocationRepository and
 * TrackLocationUseCase dependencies to the ViewModel constructor.
 *
...
class SpeedTrackingViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(SpeedTrackingViewModel::class.java)) {
            return SpeedTrackingViewModel(locationRepository, trackLocationUseCase) as T
        }
